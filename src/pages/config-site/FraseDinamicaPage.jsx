...
import ConfigFraseDinamica from '../../components/configuracao_site/ConfigFraseDinamica';

export default function FraseDinamicaPage() {
    ...
    <Flex minH="100vh" position="relative">
      ...
      <Box flex="1" display="flex" flexDirection="column" overflowY="auto">
        ...
        <Box px={{ base: 4, md: 6 }} pt={{ base: 4, md: 6 }} pb={{ base: 24, md: 6 }} maxW="100%">
          <Heading mb={6}>Texto Dinâmico do Site</Heading>
          <ConfigFraseDinamica />
        </Box>
      </Box>
      <BottomBar />
